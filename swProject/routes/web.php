...
use App\Http\Controllers\Admin\HomeController as AdminPostController;
...
//role homepages
Route::get('admin/home', [App\Http\Controllers\Admin\HomeController::class, 'index'])->name('admin.posts.index');
Route::get('user/home', [App\Http\Controllers\User\HomeController::class, 'index'])->name('user.posts.index');
